...
var fight = function (enemy) {
  ...
  while (playerInfo.health > 0 && enemy.health > 0) {
    if (isPlayerTurn) {
      // ask player if theyd like to fight or skip using fight or skip function
      if (fightOrSkip()) {
    ...
    // remove enemys health by subtracting the amount set in damage variable 
...
var getPlayerName = function() {
  ...
  while (name === '' || name === null) {
    ...
    // prompt player until valid data is recieved
    if (name === '' || name === null) {
      window. alert ('You need to put a real name silly!');
    }
